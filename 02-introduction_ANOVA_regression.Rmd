...
If we are not able to assume equal variances, we Bootstrap two-sample test to compare each group to the control and then adjust the p-value using Bonferroni.
