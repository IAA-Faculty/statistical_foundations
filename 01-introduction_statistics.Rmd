...
df=ames['Heating_QC'].value_counts().rename("HeatingSystem").reset_index(name="Frequency").reset_index()
...
```{python}
df=ames['Heating_QC'].value_counts().rename_axis('unique_values').to_frame('counts')
```
