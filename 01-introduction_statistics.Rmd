...
ames_py = pd.read_csv('Q:/My Drive/Summer II - Statistics Bootcamp/Summer2022/statistical_foundations/Ames.csv')
...
The null and alternative hypotheses for this test are typically defined as follows, so long as the two groups _have_ the same shape:
