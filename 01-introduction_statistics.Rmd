...
We saw in Figures \@ref(fig:qqplot) and \@ref(fig:histogram) that the distribution of `Sale_Price` was not perfectly normal, however the deviations from normality were not egregious. In Figure \@ref(fig:qqplotcentralair) we again examine the normality of Sale Price, this time for each value of `Central_Air`:
