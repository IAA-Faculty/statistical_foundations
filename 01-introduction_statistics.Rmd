...
```{r label='overhistogramdensitykernelAC',fig.align='center',fig.cap='Histogram: Density of Sale_Price for varying qualities ofCentral_Air'} 
ggplot(ames,aes(x=Sale_Price/1000)) + 
