...
```{python}
sm.api.qqplot(train['resid_anova_2way'])
plt.show()
...
sm.api.stats.anova_lm(model_b, typ=2)
```
...
train[['Sale_Price', 'pred_anova', 'pred_slr', 'pred_mlr']].head(n = 10)

sm.api.qqplot(train['resid_mlr'])
plt.show()
```
